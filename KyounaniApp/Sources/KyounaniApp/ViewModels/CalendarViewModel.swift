...
public final class CalendarViewModel: ObservableObject {
    ...
    @Published public private(set) var tomorrowOccurrences: [EventOccurrence] = []
    ...
    public func refresh(childFilter: ChildScope, includeDraft: Bool) {
        ...
        tomorrowOccurrences = occurrences(in: DateInterval(start: endToday, end: endTomorrow), childFilter: childFilter, includeDraft: includeDraft)
    }
